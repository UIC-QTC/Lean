...
class StandardDeviationExecutionModel(QuantConnect.Algorithm.Framework.Execution.ExecutionModel, QuantConnect.Algorithm.Framework.Execution.IExecutionModel, QuantConnect.Algorithm.Framework.INotifiedSecurityChanges):
    """
...
class VolumeWeightedAveragePriceExecutionModel(QuantConnect.Algorithm.Framework.Execution.ExecutionModel, QuantConnect.Algorithm.Framework.Execution.IExecutionModel, QuantConnect.Algorithm.Framework.INotifiedSecurityChanges):
    """
