...
namespace QuantConnect.Packets
{
    ...
    public class LeakyBucketControlParameters
    {
        ...
        public static int DefaultCapacity => Config.GetInt("scheduled-event-leaky-bucket-capacity", 5);
        public static int DefaultTimeInterval => Config.GetInt("scheduled-event-leaky-bucket-time-interval-minutes", 2);
        public static int DefaultRefillAmount => Config.GetInt("scheduled-event-leaky-bucket-refill-amount", (int)Math.Ceiling(1.0));
