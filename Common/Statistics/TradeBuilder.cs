...
namespace QuantConnect.Statistics
{
    ...
    public class TradeBuilder : ITradeBuilder
    {
        ...
        public void ProcessFill(OrderEvent fill, decimal conversionRate, decimal multiplier = 1.0m)
        {
            ...
            {
                // for purposes of building trades, track fee values in account currency only
                // which is in line w/ IRS requirements regarding cost basis
                orderFee = fill.OrderFee.ValueInAccountCurrency.Amount;
