...
namespace QuantConnect.Securities.Option
{
    ...
    public class OptionMarginModel : SecurityMarginModel
    {
        ...
        protected override Margin GetInitialMarginRequiredForOrder(InitialMarginRequiredForOrderContext context)
        {
            ...
            var initialMargin = orderValue + Math.Sign(orderValue) * orderFees;
            return context.ResultInAccountCurrency(initialMargin);
        }
        ...
        {
            var security = context.Security;
            var maintenanceMargin = security.Holdings.AbsoluteHoldingsCost * GetMaintenanceMarginRequirement(security, security.Holdings.HoldingsCost);
